  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'MVVM',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Bloc',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Android- Java/Kotlin',image: 'assets/icons/android.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'iOS - Swift',image: 'assets/icons/swift.png'),
      ],);
  }
}
